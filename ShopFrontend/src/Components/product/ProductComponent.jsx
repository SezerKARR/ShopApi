...
const ProductComponent = memo(({product}) => {
    ...
    const handleDragStart = (e) => {
        ...
        dragDiv.setAttribute('style',
            'width: 200px; height: 14px; background-color: #8f8f86;; border: 1px solid gray; ' +
            'padding: 8px; font-size: 14px; font-family: Arial; color: black; border-radius:4px'
        );
