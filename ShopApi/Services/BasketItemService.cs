...
public class BasketItemService:IBasketItemService {
    ...
    public BasketItemService(IMapper mapper, AppDbContext context,IBasketItemRepository basketItemRepository,IMemoryCache memoryCache,IUnitOfWork unitOfWork,ILogger<CategoryService> logger) {
        _mapper = mapper;
        _context = context;
